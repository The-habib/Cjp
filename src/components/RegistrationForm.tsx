  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="name" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Name *</label>
        <input
          id="name"
          required
          type="text"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="phone" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Phone (optional)</label>
        <input
          id="phone"
          type="text"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="lazy" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Are you lazy?</label>
        <select
          id="lazy"
          value={formData.lazy}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="twitterHandle" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Twitter Handle (optional)</label>
        <input
          id="twitterHandle"
          type="text"
