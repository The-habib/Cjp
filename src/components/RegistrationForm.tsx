  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-name" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Name *</label>
        <input
          id="reg-name"
          required
          type="text"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-phone" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Phone (optional)</label>
        <input
          id="reg-phone"
          type="text"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-chronicallyOnline" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>
          Are you chronically online?
        </label>
        <select
          id="reg-chronicallyOnline"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-lazy" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Are you lazy?</label>
        <select
          id="reg-lazy"
          value={formData.lazy}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-identifyAsCockroach" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>
          Do you identify as a "cockroach" as defined by the CJI?
        </label>
        <select
          id="reg-identifyAsCockroach"
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
        <label htmlFor="reg-twitterHandle" style={{ fontSize: "0.85rem", fontWeight: "bold" }}>Twitter Handle (optional)</label>
        <input
          id="reg-twitterHandle"
          type="text"
