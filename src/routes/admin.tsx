...
function AdminPanel() {
  ...
  // ⚡ Bolt Optimization: Memoized array filtering to prevent O(n) recalculations on unrelated state changes (like switching tabs).
  // Reduces unnecessary re-renders when navigating the dashboard.
