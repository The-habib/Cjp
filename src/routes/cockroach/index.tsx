      ...
      <main className="w-full sm:w-[600px] sm:border-r border-white/10 min-h-screen pb-20 sm:pb-0 z-10">
        ...
        <div className="sticky top-0 z-50 bg-[#050505]/80 backdrop-blur-md border-b border-white/10">
          <div className="px-4 py-3 flex items-center cursor-pointer">
            ...
            <h1 className="text-xl font-bold leading-tight font-['Archivo_Black'] uppercase tracking-tight ml-2 sm:ml-0">Home</h1>
          </div>
          ...
          <div className="flex">
            ...
            >
              <div className={`pb-3 font-['Space_Mono'] uppercase ${activeTab === "videos" ? "border-b-4 border-[#c8ff00] text-white" : "border-b-4 border-transparent text-[#888]"}`}>For you</div>
            </div>
            <div 
        ...
        {/* Feed List */}
        <div>
           {activeTab === "videos" ? allVideos.map((video, idx) => (
             <div 
               key={video.id} 
