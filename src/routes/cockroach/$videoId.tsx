      ...
      <main className="w-full sm:w-[600px] sm:border-r border-white/10 min-h-screen pb-20 sm:pb-0 z-10">
        ...
        <div className="p-4 border-b border-white/10">
          ...
          <div className="border-t border-white/10 pt-1 flex justify-between text-[#888] mt-1 -mx-2 px-2">
            <button aria-label="Reply" className="flex items-center gap-2 hover:text-[#c8ff00] group/btn transition-colors">
              <div className="p-2 rounded-full group-hover/btn:bg-[#c8ff00]/10 transition-colors">
                <MessageCircle className="w-[22px] h-[22px]" />
              </div>
            </button>
            <button aria-label="Repost" className="flex items-center gap-2 hover:text-[#00ba7c] group/btn transition-colors">
              <div className="p-2 rounded-full group-hover/btn:bg-[#00ba7c]/10 transition-colors">
                <Repeat2 className="w-[22px] h-[22px]" />
              </div>
            </button>
            <button aria-label="Like" className="flex items-center gap-2 hover:text-[#f91880] group/btn transition-colors">
              <div className="p-2 rounded-full group-hover/btn:bg-[#f91880]/10 transition-colors">
                <Heart className="w-[22px] h-[22px]" />
              </div>
            </button>
            <button aria-label="View" className="flex items-center gap-2 hover:text-[#c8ff00] group/btn transition-colors">
              <div className="p-2 rounded-full group-hover/btn:bg-[#c8ff00]/10 transition-colors">
                <BarChart2 className="w-[22px] h-[22px]" />
              </div>
            </button>
            <div className="flex gap-1">
              <button aria-label="Bookmark" className="flex items-center gap-2 hover:text-[#c8ff00] group/btn transition-colors">
                <div className="p-2 rounded-full group-hover/btn:bg-[#c8ff00]/10 transition-colors">
        ...
        <div className="p-4 border-b border-white/10 flex gap-3 pb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex justify-between items-center border-t border-white/10 mt-4 pt-3">
              ...
              <button disabled className="bg-[#c8ff00]/50 text-black/50 font-bold rounded-full px-4 py-1.5 cursor-not-allowed font-['Archivo_Black'] uppercase tracking-wide">
                Reply
              </button>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex justify-between text-[#888] max-w-md -ml-2 font-['Space_Mono']">
                <button aria-label="Reply" className="p-2 hover:bg-[#c8ff00]/10 hover:text-[#c8ff00] rounded-full transition-colors">
                  <MessageCircle className="w-[18px] h-[18px]" />
                </button>
                <button aria-label="Repost" className="p-2 hover:bg-[#00ba7c]/10 hover:text-[#00ba7c] rounded-full transition-colors">
                  <Repeat2 className="w-[18px] h-[18px]" />
                </button>
                <button aria-label="Like" className="p-2 hover:bg-[#f91880]/10 hover:text-[#f91880] rounded-full transition-colors">
                  <Heart className="w-[18px] h-[18px]" />
                </button>
                <button aria-label="View" className="p-2 hover:bg-[#c8ff00]/10 hover:text-[#c8ff00] rounded-full transition-colors">
                  <BarChart2 className="w-[18px] h-[18px]" />
                </button>
                <div className="flex gap-1">
                  <button aria-label="Bookmark" className="p-2 hover:bg-[#c8ff00]/10 hover:text-[#c8ff00] rounded-full transition-colors">
                    <Bookmark className="w-[18px] h-[18px]" />
                  </button>
                  <button aria-label="Share" className="p-2 hover:bg-[#00f0ff]/10 hover:text-[#00f0ff] rounded-full transition-colors">
